...
def main(argv=None):
    ...
    parser.add_argument("-proxy", default=None, help="代理：{'http':'http://127.0.0.1:8888','https:':'https://127.0.0.1:8888'}")
...
if __name__ == '__main__':
    ...
    # m3u8url = 'http://pl-ali.youku.com/playlist/m3u8?vid=XNTg2OTY0MjkxNg%3D%3D&type=3gphdv3&ups_client_netip=3b34346a&utid=YQzzbUfQKskDACkjGHf6ePHc&ccode=01010101&psid=a5d49bd800e5246aab9b8f96427a78d340346&ups_userid=1152626102&ups_ytid=1152626102&app_ver=8.4.2&duration=6533&expire=18000&drm_type=7&drm_device=1&media_type=standard,subtitle&dyt=0&btf=&rid=20000000211C59379D4B93E0928FB4B00EC12B8D02000000&ups_ts=1655177472&onOff=0&encr=0&ups_key=fc0c00f86c7850cb22e5ad044f82d5a9'
    # method = 'default'
    # m3u8download(m3u8url,method=method)
